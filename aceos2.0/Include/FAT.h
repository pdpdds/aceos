...
a FAT file system (FAT-12,16 and 32 are Supported).
					-Samuel ( 28-Jan-2001)
	Modified on 13-Nov-2001 (static Disk and Partion classes)
	Modified on 09-Sep-2002 for Ace OS
        Modified on 03-Jun-2003 
            Replaced Collection with List
            standard C Library is used instead of many functions such AllocHeap, StrCpy etc
