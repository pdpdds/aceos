;*************************************************************************
; Ace OS FAT12 3.5" floppy Boot Code 
;*************************************************************************
[BITS 16]
...
jmp     START
     ...
     ; read image file into memory
          mov     ax, OSLoaderSegment                          ; destination of image CS
          mov     es, ax
     ...
     cluster     dw 0x0000
     ImageName   db "OSLOADERBIN"
     msgLoading  db 0x0D, 0x0A, "Loading OS Loader ", 0x00
